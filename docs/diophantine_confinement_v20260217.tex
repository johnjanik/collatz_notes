...
\begin{tabular}{lll}
  ...
  Drift $\to$ divergence & \texttt{Drift.lean} &
    Linear lower bound on walk \\
...
\begin{tabular}{clll}
  ...
  8 & \texttt{Drift.lean} &
    \texttt{podd\_uniform\_bound} &
    Ergodic theory \\
  9 & \texttt{CorrectionRatio.lean} &
    \texttt{no\_cycle\_delta3\_ge2} &
    Baker for cycles \\
  \bottomrule
\end{tabular}
\end{center}
...
geometry.  Item~8 is hypothesis~(H1)---the ergodic input.  Item~9 is
the application of Baker's theorem to exclude cycles with
