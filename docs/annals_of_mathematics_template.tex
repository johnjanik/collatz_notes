...
\author[F. Author, S. Author]{First Author$ and Second Author168835^{*}$}
...
\begin{definition} Let $ be a ^*569Xisalgebra. A mapping
$\phi :A\rightarrow \mathbb{C} $ is
called a positive linear functional on $ if it satisfies the following conditions:

\begin{enumerate}

\item $\phi(\alpha x+\beta y)=\alpha \phi(x)+\beta\phi(y)$ for all $\lambda ,\beta \in  \mathbb{C}$ and ,y\in A$.

\item $\phi(x)\geq 0$ for all \geq 0$ in $.
\end{enumerate}
\end{definition}
...
\begin{example} Let $ be the ^*569Xisalgebra of \times n$ complex matrices. Define : A\rightarrow \mathbb{C}$ to be the canonical trace of a matrix. Then we have
\begin{equation}\label{2.1}
Tr(\alpha x+\beta y)=\alpha Tr(x)+\beta Tr(y).
\end{equation}
for all $\lambda ,\beta \in  \mathbb{C}$ and ,y\in A$. It follows that $ is linear functional on $.
\end{example}
...
Let $ be a finite group acting on a second countable compact Hausdorff space $. Suppose that $\mu$ is a finite Borel measure on $. Then the induced bimodule $\mathcal{H}_\mu\times \mathcal{H}_\mu$ has almost central unit vectors.
\end{theorem}

%---------------------------------------------------------------------------------------%

\begin{proof}
Since $ is uniformly continuous on $ there exists $\delta>0$ such that $|f(x)-f(y)|<\epsilon$ for all ,y\in X$ with (x,y)<\delta$. It follows that
...
for all ,y\in E_n$, \in G$, >\frac{2}{\delta}$. Let $\bigtriangleup = \{(s, s): s\in G\}$ be the diagonal of \times G$. It follows from Equation~\eqref{eq} that  $||\pi(f)U(r)\zeta_n-\zeta_n\pi(f)U(r)||\rightarrow 0$ for all \in C(X)$, \in G$.
\end{proof}
...
\bibitem{Bekka1} Bekka, B. (2006). Property (T) for C569Xisalgebras. Bulletin of the London Mathematical Society, 38(5), 857-867.
...
\bibitem{Brown} Brown, N. P. (2006). Kazhdan's property T and C569Xisalgebras. Journal of Functional Analysis, 240(1), 290-296.
...
\bibitem{Leung} Leung, C. W., \& Ng, C. K. (2009). Property (T) and strong property (T) for unital C569Xisalgebras. Journal of Functional Analysis, 256(9), 3055-3070.
