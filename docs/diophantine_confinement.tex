...
Nine \texttt{sorry} axioms remain, grouped into four categories:
...
\begin{tabular}{clll}
  ...
  6 & \texttt{TunnelWidth.lean} &
    \texttt{tunnel\_walls\_positive\_of\_baker} &
    Geometric bridge \\
  7 & \texttt{TunnelWidth.lean} &
    \texttt{tunnel\_foliation\_intersection} &
    Weyl equidistribution \\
  8 & \texttt{Drift.lean} &
    \texttt{nu3\_linear\_bound} &
    K-bound (critical path) \\
  9 & \texttt{CorrectionRatio.lean} &
...
Mathlib precedent.  Items 6--7 bridge the Baker bound to the tunnel
geometry.  Item~8 is the K-bound: the sole \texttt{sorry} on the
...
Item~9 is the application of Baker's theorem to exclude cycles with
